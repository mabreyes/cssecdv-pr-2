...
db.serialize(() => {
    ...
    db.run(`CREATE UNIQUE INDEX IF NOT EXISTS idx_users_username_lower ON users(LOWER(username))`);
    ...
    const reservedUsernames = [
        ...
        'help', 'info', 'webmaster', 'moderator', 'staff'
    ];

    const stmt = db.prepare('INSERT OR IGNORE INTO username_blacklist (username) VALUES (?)');
